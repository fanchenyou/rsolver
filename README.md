...
```
[Cayley-SGD] 
python main.py --save ./models/CayleySGD --model resnet --depth 28 --width 10 --optim_method Cayley_SGD --lr 0.8 --lrg 0.1 --lr_decay_ratio 0.2 --gpu_id 0
[Cayley-SGD-Adaptive] 
python main.py --save ./models/CayleySGD_Adaptive --model resnet --depth 16 --width 5 --optim_method Cayley_SGD_ADP --lr 0.8 --lrg 0.1 --lr_decay_ratio 0.2 
